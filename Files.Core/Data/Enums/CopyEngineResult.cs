...
public struct CopyEngineResult
{
	...
	public static FileSystemStatusCode Convert(int? hres)
	{
		return hres switch
		{
            S_OK => FileSystemStatusCode.Success,
			COPYENGINE_E_ACCESS_DENIED_SRC => FileSystemStatusCode.Unauthorized,
			COPYENGINE_E_ACCESS_DENIED_DEST => FileSystemStatusCode.Unauthorized,
			COPYENGINE_E_REQUIRES_ELEVATION => FileSystemStatusCode.Unauthorized,
			COPYENGINE_E_RECYCLE_PATH_TOO_LONG => FileSystemStatusCode.NameTooLong,
			COPYENGINE_E_NEWFILE_NAME_TOO_LONG => FileSystemStatusCode.NameTooLong,
			COPYENGINE_E_NEWFOLDER_NAME_TOO_LONG => FileSystemStatusCode.NameTooLong,
			COPYENGINE_E_PATH_TOO_DEEP_SRC => FileSystemStatusCode.NameTooLong,
			COPYENGINE_E_PATH_TOO_DEEP_DEST => FileSystemStatusCode.NameTooLong,
			COPYENGINE_E_PATH_NOT_FOUND_SRC => FileSystemStatusCode.NotFound,
			COPYENGINE_E_PATH_NOT_FOUND_DEST => FileSystemStatusCode.NotFound,
			COPYENGINE_E_NET_DISCONNECT_DEST => FileSystemStatusCode.NotFound,
			COPYENGINE_E_NET_DISCONNECT_SRC => FileSystemStatusCode.NotFound,
			COPYENGINE_E_CANT_REACH_SOURCE => FileSystemStatusCode.NotFound,
			COPYENGINE_E_ALREADY_EXISTS_NORMAL => FileSystemStatusCode.AlreadyExists,
			COPYENGINE_E_ALREADY_EXISTS_READONLY => FileSystemStatusCode.AlreadyExists,
			COPYENGINE_E_ALREADY_EXISTS_SYSTEM => FileSystemStatusCode.AlreadyExists,
			COPYENGINE_E_ALREADY_EXISTS_FOLDER => FileSystemStatusCode.AlreadyExists,
			COPYENGINE_E_FILE_TOO_LARGE => FileSystemStatusCode.FileTooLarge,
			COPYENGINE_E_FILE_IS_FLD_DEST => FileSystemStatusCode.NotAFile,
			COPYENGINE_E_FLD_IS_FILE_DEST => FileSystemStatusCode.NotAFolder,
			COPYENGINE_E_SHARING_VIOLATION_SRC => FileSystemStatusCode.InUse,
			COPYENGINE_E_SHARING_VIOLATION_DEST => FileSystemStatusCode.InUse,
			COPYENGINE_E_STREAM_LOSS => FileSystemStatusCode.PropertyLoss,
			COPYENGINE_E_EA_LOSS => FileSystemStatusCode.PropertyLoss,
			COPYENGINE_E_PROPERTY_LOSS => FileSystemStatusCode.PropertyLoss,
			COPYENGINE_E_PROPERTIES_LOSS => FileSystemStatusCode.PropertyLoss,
			COPYENGINE_E_ENCRYPTION_LOSS => FileSystemStatusCode.PropertyLoss,
