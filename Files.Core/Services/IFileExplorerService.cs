...
public interface IFileExplorerService
{
	...
	Task<ILocatableFile?> PickSingleFileAsync(IFolderViewViewModel viewModel, IEnumerable<string>? filter, CancellationToken cancellationToken = default);
	...
	Task<ILocatableFolder?> PickSingleFolderAsync(IFolderViewViewModel viewModel, CancellationToken cancellationToken = default);
}
