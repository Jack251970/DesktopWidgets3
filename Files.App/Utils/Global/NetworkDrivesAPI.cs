...
public class NetworkDrivesAPI
{
	...
	public static async Task<bool> AuthenticateNetworkShare(IFolderViewViewModel viewModel, string path)
	{
		...
		{
            /*await DialogDisplayHelper.ShowDialogAsync("NetworkFolderErrorDialogTitle".ToLocalized(), connectionError.ToString().Split(":")[1].Trim());*/
            return false;
		}
	}
