...
public sealed class PreviewHandler : IDisposable
{
	...
	private void SetupHandler(Guid clsid)
	{
		...
		var hr = Win32PInvoke.CoCreateInstance(ref clsid, IntPtr.Zero, Win32PInvoke.ClassContext.LocalServer, ref iid, out pph);
        ...
        if (previewHandlerObject is not IObjectWithSite objectWithSite)
        {
        ...
        visuals = (IPreviewHandlerVisuals)previewHandlerObject;
	}
    ...
    private void Dispose(bool disposing)
	{
		...
		else
		{
            ...
            if (phObject is IPreviewHandler ph)
            {
                ph.Unload();
            }
