...
public sealed class GitHubLoginDialogViewModel : ObservableObject
{
	...
	private CancellationTokenSource LoginCancellationToken { get; init; }
	...
	public GitHubLoginDialogViewModel(string userCode, string subtitle, CancellationTokenSource loginCTS)
	{
		UserCode = userCode;
		Subtitle = subtitle;
		LoginCancellationToken = loginCTS;
		LoginUrl = URL;
		NavigateUri = new Uri(URL);

		CloseButtonCommand = new RelayCommand(LoginCancellationToken.Cancel);
	}
}
