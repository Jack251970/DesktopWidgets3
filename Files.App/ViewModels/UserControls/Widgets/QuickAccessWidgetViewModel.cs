...
public sealed class QuickAccessWidgetViewModel : BaseWidgetViewModel, IWidgetViewModel
{
	...
	public async override Task ExecutePinToSidebarCommand(WidgetCardItem? item)
	{
	...
	public async override Task ExecuteUnpinFromSidebarCommand(WidgetCardItem? item)
	{
		if (item is null || item.Path is null)
        {
            return;
