...
internal sealed class LayoutDetailsAction(IDisplayPageContext context) : ToggleLayoutAction(context)
{
...
internal sealed class LayoutListAction(IDisplayPageContext context) : ToggleLayoutAction(context)
{
    protected override LayoutTypes LayoutType
        => LayoutTypes.List;
...
internal sealed class LayoutTilesAction(IDisplayPageContext context) : ToggleLayoutAction(context)
{
	protected override LayoutTypes LayoutType
		=> LayoutTypes.Tiles;
...
internal sealed class LayoutGridAction(IDisplayPageContext context) : ToggleLayoutAction(context)
{
    protected override LayoutTypes LayoutType
        => LayoutTypes.Grid;
...
internal sealed class LayoutColumnsAction(IDisplayPageContext context) : ToggleLayoutAction(context)
{
	protected override LayoutTypes LayoutType
		=> LayoutTypes.Columns;
...
internal sealed class LayoutAdaptiveAction(IDisplayPageContext context) : ToggleLayoutAction(context)
{
    protected override LayoutTypes LayoutType
...
internal abstract class ToggleLayoutAction : ObservableObject, IToggleAction
{
	...
	public ToggleLayoutAction(IDisplayPageContext context)
	{
		Context = context;
...
internal sealed class LayoutDecreaseSizeAction : ObservableObject, IAction
{
    ...
    private readonly IDisplayPageContext DisplayPageContext;
