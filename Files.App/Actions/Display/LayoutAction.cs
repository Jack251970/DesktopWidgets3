...
internal class LayoutDetailsAction : ToggleLayoutAction
{
    ...
    public LayoutDetailsAction(IDisplayPageContext context) : base(context)
    {
    }
}
...
internal class LayoutDecreaseSizeAction : IAction
{
	...
	public LayoutDecreaseSizeAction(IDisplayPageContext context)
    {
...
internal class LayoutIncreaseSizeAction : IAction
{
	...
	public LayoutIncreaseSizeAction(IDisplayPageContext context)
    {
        this.context = context;
    }
