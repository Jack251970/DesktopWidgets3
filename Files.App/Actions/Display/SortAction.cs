...
internal abstract class SortByAction : ObservableObject, IToggleAction
{
	...
	public SortByAction(IContentPageContext contentPageContext, IDisplayPageContext displayPageContext)
    {
...
internal class SortAscendingAction : ObservableObject, IToggleAction
{
	...
	public SortAscendingAction(IDisplayPageContext context)
    {
...
internal class SortDescendingAction : ObservableObject, IToggleAction
{
	...
	public SortDescendingAction(IDisplayPageContext context)
    {
        this.context = context;
