...
internal class UnpinItemAction : ObservableObject, IAction
{
	...
	public UnpinItemAction(IFolderViewViewModel folderViewViewModel, IContentPageContext context)
    {
	...
	{
		var favorites = App.QuickAccessManager.Model.FavoriteItems.ToArray();
