...
internal sealed class OpenInNewPaneFromSidebarAction(IFolderViewViewModel folderViewViewModel, IContentPageContext context) : BaseOpenInNewPaneAction(folderViewViewModel, context)
{
