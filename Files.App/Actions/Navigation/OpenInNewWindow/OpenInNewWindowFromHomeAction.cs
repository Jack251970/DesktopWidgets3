...
internal sealed class OpenInNewWindowFromHomeAction(IFolderViewViewModel folderViewViewModel, IContentPageContext context) : BaseOpenInNewWindowAction(folderViewViewModel, context)
{
