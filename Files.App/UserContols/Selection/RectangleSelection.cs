...
public class RectangleSelection
{
	...
	{
		if (uiElement is ListViewBase lv)
		{
			return new RectangleSelection_ListViewBase(lv, selectionRectangle, selectionChanged);
		}
		else
		{
	...
	public event SelectionStatusHandler SelectionStarted = null!;

	public event SelectionStatusHandler SelectionEnded = null!;
	...
	protected void DrawRectangle(PointerPoint currentPoint, Point originDragPointShifted, FrameworkElement uiElement)
	{
		...
		{
			var maxWidth = uiElement.ActualWidth - originDragPointShifted.X;
