...
{
    private HashesViewModel HashesViewModel { get; set; } = null!;
	...
	protected override void OnNavigatedTo(NavigationEventArgs e)
	{
		...
		if (np.FolderViewViewModel is IFolderViewViewModel folderViewViewModel && np.Parameter is ListedItem listedItem)
        {
            HashesViewModel = new(folderViewViewModel, listedItem);
        }
