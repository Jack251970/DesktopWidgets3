...
{
	private readonly Regex letterRegex = MyRegex();
	...
	public async override Task<bool> SaveChangesAsync()
	{
		...
		bool GetNewName(out string newName)
		{
			if (ItemFileName is not null)
			{
				...
				var oldName = ViewModel.OriginalItemName;
		...
		bool SaveDrive(DriveItem drive)
		{
            ...
            _ = UIThreadExtensions.DispatcherQueue.EnqueueOrInvokeAsync(async () =>
			{
		...
		async Task<bool> SaveBaseAsync(ListedItem item)
		{
            ...
            return await UIThreadExtensions.DispatcherQueue.EnqueueOrInvokeAsync(() =>
