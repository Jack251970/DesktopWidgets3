...
internal sealed class DummyUpdateService : IUpdateService
{
	...
	public Task CheckForUpdatesAsync(IFolderViewViewModel folderViewViewModel)
	{
		return Task.CompletedTask;
	}
	...
	public Task DownloadMandatoryUpdatesAsync(IFolderViewViewModel folderViewViewModel)
	{
		return Task.CompletedTask;
	}

	public Task DownloadUpdatesAsync(IFolderViewViewModel folderViewViewModel)
	{
		return Task.CompletedTask;
	}
