...
public sealed partial class SpeedGraph : Control
{
    ...
    private CompositionPathGeometry graphGeometry;
    private InsetClip graphClip;

    private SpriteVisual line;

    private CompositionColorBrush backgroundBrush;
    private CompositionColorGradientStop graphFillBottom;
    private CompositionColorGradientStop graphFillTop;
    private CompositionColorBrush graphStrokeBrush;

    private LinearEasingFunction linearEasing;
	...
	public SpeedGraph()
	{
		...
		themeModeService = DependencyExtensions.GetRequiredService<IAppThemeModeService>();
	...
	private void OnSizeChanged(object sender, SizeChangedEventArgs e)
	{
        ...
        // CHANGE: Use ThemeExtensions instead of themeModeService.
        ThemeExtensions.ElementTheme_Changed += (s, t) => OnAppThemeModeChanged(s, EventArgs.Empty);
	}
	...
	private float YValue(float y) => height - (y / highestValue) * (height - 48f) - 4;
    ...
    private CompositionPath CreatePathFromPoints()
	{
    ...
    private void SetGraphColors()
	{
		...
		var slightlyDarkerColor = ActualTheme switch
		{
