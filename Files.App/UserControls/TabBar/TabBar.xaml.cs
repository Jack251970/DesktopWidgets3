...
#pragma warning restore CA1822 // Mark members as static
    ...
    /*private void TabView_TabItemsChanged(TabView sender, Windows.Foundation.Collections.IVectorChangedEventArgs args)
	{
        ...
        {
            FolderViewViewModel.TabStripSelectedIndex = Items.IndexOf(HorizontalTabView.SelectedItem as TabBarItem);
        }
        ...
        HorizontalTabView.SelectedIndex = FolderViewViewModel.TabStripSelectedIndex;
    }
	...
	private async void TabView_TabStripDrop(object sender, DragEventArgs e)
	{
        ...
        if (!e.DataView.Properties.TryGetValue(TabPathIdentifier, out var tabViewItemPathObj) ||
		...
		for (var i = 0; i < tabStrip.TabItems.Count; i++)
		{
	...
	private void TabView_TabDragCompleted(TabView sender, TabViewTabDragCompletedEventArgs args)
	{
		...
		if (ApplicationData.Current.LocalSettings.Values.TryGetValue(TabDropHandledIdentifier, out var value) &&
			(bool)value)
        {
