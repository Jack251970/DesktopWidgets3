...
public sealed partial class ShellPreview : UserControl
{
	...
	public ShellPreview(IFolderViewViewModel folderViewViewModel, ShellPreviewViewModel model)
	{
	...
	{
		ViewModel.LoadPreview(FolderViewViewModel, contentPresenter);
	...
	private RECT GetPreviewSize()
	{
        ...
        var result = new RECT
        {
            Left = (int)(physicalPos.X * scale + 0.5),
            Top = (int)(physicalPos.Y * scale + 0.5),
	...
	{
		ViewModel.PointerEntered((sender as ContentPresenter) == contentPresenter);
	}
}
