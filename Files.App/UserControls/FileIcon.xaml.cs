...
{
    private SelectedItemsPropertiesViewModel viewModel = null!;
	...
	{
		get => (BitmapImage)GetValue(FileIconImageSourceProperty);
	...
	{
		get => (byte[])GetValue(FileIconImageDataProperty);
		set
		{
    ...
    private SvgImageSource CustomIconImageSource { get; set; } = null!;
