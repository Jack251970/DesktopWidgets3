...
{
	private static readonly ShellFolder _controlPanel = new(Shell32.KNOWNFOLDERID.FOLDERID_ControlPanelFolder);

	private static readonly ShellFolder _controlPanelCategoryView = new("::{26EE0668-A00A-44D7-9371-BEB064C98683}");
	...
	{
		var queryBinInfo = new Win32PInvoke.SHQUERYRBINFO();
