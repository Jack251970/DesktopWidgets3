...
public static partial class Win32Helper
{
	...
	public static List<Process> WhoIsLocking(string[] resources)
	{
		...
		var res = Win32PInvoke.RmStartSession(out var handle, 0, key);
		if (res != 0)
        {
        ...
        try
		{
            ...
            res = Win32PInvoke.RmGetList(handle, out var pnProcInfoNeeded, ref pnProcInfo, null!, ref lpdwRebootReasons);
