...
internal sealed class DisplayPageContext : ObservableObject, IDisplayPageContext
{
    ...
    {
        Context = folderViewViewModel.GetRequiredService<IMultiPanesContext>();
	...
	private LayoutTypes GetLayoutType()
	{
        ...
        var isAdaptive = IsLayoutAdaptiveEnabled && viewModel.IsAdaptiveLayoutEnabled && !viewModel.IsLayoutModeFixed;
		if (isAdaptive)
        {
