...
public sealed class TabBarItemParameter
{
    ...
    public string Serialize()
	{
        ...
        var tempArgs = new TabBarItemParameterJson() { InitialPageType = InitialPageType, NavigationParameter = NavigationParameter };
    ...
    public static TabBarItemParameter Deserialize(IFolderViewViewModel folderViewViewModel, string obj)
	{
        ...
        var tempArgs = TabBarItemParameterJson.Deserialize(obj);
...
public sealed class TabBarItemParameterJson
{
    ...
    public static TabBarItemParameterJson Deserialize(string obj)
    {
        var tabArgs = new TabBarItemParameterJson();
