...
/// </summary>
public abstract class BaseDatabaseModel<TDictionaryValue>(IAsyncSerializer<Stream> serializer) : IDatabaseModel<string>
{
	protected readonly IAsyncSerializer<Stream> serializer = serializer;
	protected readonly SemaphoreSlim storageSemaphore = new(1, 1);
	protected readonly ConcurrentDictionary<string, TDictionaryValue> settingsCache = new();
