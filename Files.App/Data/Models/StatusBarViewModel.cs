...
public sealed class StatusBarViewModel : ObservableObject
{
    ...
    private IDevToolsSettingsService DevToolsSettingsService { get; set; } = null!;
    ...
    public bool ShowOpenInIDEButton => DevToolsSettingsService.OpenInIDEOption == OpenInIDEOption.AllLocations ||
