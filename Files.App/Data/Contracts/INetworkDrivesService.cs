...
public interface INetworkDrivesService
{
	...
	/// </summary>
	/// <returns></returns>
	Task OpenMapNetworkDriveDialogAsync(IFolderViewViewModel folderViewViewModel);
	...
	Task<bool> AuthenticateNetworkShare(IFolderViewViewModel folderViewViewModel, string path);
}
