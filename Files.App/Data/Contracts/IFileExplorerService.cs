...
public interface IFileExplorerService
{
	...
	Task<ILocatableFile?> PickSingleFileAsync(IFolderViewViewModel folderViewViewModel, IEnumerable<string>? filter, CancellationToken cancellationToken = default);
	...
	Task<ILocatableFolder?> PickSingleFolderAsync(IFolderViewViewModel folderViewViewModel, CancellationToken cancellationToken = default);
}
