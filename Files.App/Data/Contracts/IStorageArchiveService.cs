...
public interface IStorageArchiveService
{
	...
	Task<bool> CompressAsync(IFolderViewViewModel folderViewViewModel, ICompressArchiveModel compressionModel);
	...
	Task<bool> DecompressAsync(IFolderViewViewModel folderViewViewModel, string archiveFilePath, string destinationFolderPath, string password = "");
