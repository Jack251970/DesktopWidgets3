...
{
    public static FrozenDictionary<KeyModifiers, string> LocalizedModifiers
    {
        get;
    } = new Dictionary<KeyModifiers, string>()
    {
    ...
    public static FrozenDictionary<Keys, string> LocalizedKeys
    {
        get;
