...
public static class ShellFolderExtensions
{
    ...
    public static ShellFileItem? GetShellFileItem(ShellItem folderItem)
    {
        ...
        var isFolder = folderItem.IsFolder && folderItem.IShellItem?.GetAttributes(Shell32.SFGAO.SFGAO_STREAM) is 0;
        ...
        var filePath = Path.IsPathRooted(itemNameOrOriginalPath) ? itemNameOrOriginalPath : parsingPath;
