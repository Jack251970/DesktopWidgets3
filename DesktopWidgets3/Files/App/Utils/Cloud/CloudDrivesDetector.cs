...
public class CloudDrivesDetector
{
    ...
    public static async Task<IEnumerable<ICloudProvider>> DetectCloudDrives()
    {
        ...
        {
                SafetyExtensions.IgnoreExceptions(DetectOneDrive)!,
                SafetyExtensions.IgnoreExceptions(DetectSharepoint)!,
                SafetyExtensions.IgnoreExceptions(DetectGenericCloudDrive)!,
                SafetyExtensions.IgnoreExceptions(DetectYandexDisk)!,
                SafetyExtensions.IgnoreExceptions(DetectpCloudDrive)!,
                SafetyExtensions.IgnoreExceptions(DetectNutstoreDrive)!,
                SafetyExtensions.IgnoreExceptions(DetectSeadriveDrive)!,
                SafetyExtensions.IgnoreExceptions(DetectAutodeskDrive)!,
        };
    ...
    private static Task<IEnumerable<ICloudProvider>> DetectpCloudDrive()
    {
        ...
        if (syncedFolder is not null)
        {
            ...
            DesktopWidgets3.App.AppModel.PCloudDrivePath = syncedFolder;
