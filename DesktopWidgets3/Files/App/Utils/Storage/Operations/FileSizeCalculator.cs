...
internal class FileSizeCalculator
{
    ...
    public async Task ComputeSizeAsync(CancellationToken? cancellationToken)
    {
        cancellationToken ??= CancellationToken.None;
        await Parallel.ForEachAsync(_paths, (CancellationToken)cancellationToken, async (path, token) => await Task.Factory.StartNew(() =>
        {
