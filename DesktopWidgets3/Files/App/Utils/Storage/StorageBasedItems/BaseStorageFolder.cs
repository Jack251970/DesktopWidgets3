...
public abstract class BaseStorageFolder : IBaseStorageFolder
{
    ...
    public abstract DateTimeOffset DateCreated
    {
        get;
    }
    ...
    public abstract string FolderRelativeId
    {
        get;
    }

    public abstract IStorageItemExtraProperties Properties
    {
        get;
    }
    ...
    {
        return value is not null ? new SystemStorageFolder(value) : null!;
    }
