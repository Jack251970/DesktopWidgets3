...
public class StatusCenterItemProgressModel : INotifyPropertyChanged
{
    ...
    public long ProcessedSize => _ProcessedSize;
    ...
    public long ProcessedItemsCount => _ProcessedItemsCount;

    public double ProcessingSizeSpeed
    {
        get; private set;
    }

    public double ProcessingItemsCountSpeed
    {
        get; private set;
    }
