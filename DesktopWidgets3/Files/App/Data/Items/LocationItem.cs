...
public class LocationItem : ObservableObject//, INavigationControlItem
{
    ...
    public BulkConcurrentObservableCollection<INavigationControlItem>? ChildItems
    {
        get; set;
    }*/
    public IconSource? IconSource => new ImageIconSource()
    {
        ImageSource = icon
    };
    ...
    public ContextMenuOptions MenuOptions
    {
        get; set;
    }
...
public class RecycleBinLocationItem : LocationItem
{
    ...
    {
        /*DesktopWidgets3.App.DispatcherQueue.TryEnqueue(() =>
        {
    ...
    public override object ToolTip => SpaceUsed.ToSizeString();
