...
public class ContextMenuFlyoutItemViewModel
{
    ...
    public string GlyphFontFamilyName
    {
        get; set;
    }
    ...
    public ContextMenuFlyoutItemType ItemType
    {
        get; set;
    }

    public Func<Task> LoadSubMenuAction
    {
        get; set;
    }

    public List<ContextMenuFlyoutItemViewModel> Items
    {
        get; set;
    }
    ...
    public bool ShowInRecycleBin
    {
        get; set;
    }

    public bool ShowInSearchPage
    {
        get; set;
    }

    public bool ShowInFtpPage
    {
        get; set;
    }

    public bool ShowInZipPage
    {
        get; set;
    }
    ...
    public OpacityIconModel OpacityIcon
    {
        get; set;
    }
