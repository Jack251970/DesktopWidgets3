...
internal class CommandManager : ICommandManager
{
    ...
    /*public IRichCommand this[HotKey hotKey]
        => hotKeys.TryGetValue(hotKey with
        {
            IsVisible = true
        }, out var command) ? command
        : hotKeys.TryGetValue(hotKey with
        {
            IsVisible = false
        }, out command) ? command
    ...
    private static IDictionary<CommandCodes, IAction> CreateActions(FolderViewViewModel viewModel) => new Dictionary<CommandCodes, IAction>
    {
        ...
        [CommandCodes.ShareItem] = new ShareItemAction(viewModel),
        ...
        [CommandCodes.CopyItem] = new CopyItemAction(viewModel),
        [CommandCodes.CopyPath] = new CopyPathAction(viewModel),
        /*[CommandCodes.CopyPathWithQuotes] = new CopyPathWithQuotesAction(),*/
        [CommandCodes.CutItem] = new CutItemAction(viewModel),
        [CommandCodes.PasteItem] = new PasteItemAction(viewModel),
        [CommandCodes.PasteItemToSelection] = new PasteItemToSelectionAction(viewModel),
        [CommandCodes.DeleteItem] = new DeleteItemAction(viewModel),
        ...
        [CommandCodes.OpenItem] = new OpenItemAction(viewModel),
        [CommandCodes.OpenItemWithApplicationPicker] = new OpenItemWithApplicationPickerAction(viewModel),
