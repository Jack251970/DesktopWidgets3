...
public class NativeDirectoryChangesHelper
{
	...
	[DllImport("api-ms-win-core-synch-l1-2-0.dll", SetLastError = true)]
	public static extern uint WaitForSingleObjectEx(IntPtr hHandle, UInt32 dwMilliseconds, bool bAlertable);
	...
	public static unsafe extern bool ReadDirectoryChangesW(IntPtr hDirectory, byte* lpBuffer,
