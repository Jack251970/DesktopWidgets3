...
namespace DesktopWidgets3.Models.Component;

/// <summary>
/// A base class for page of which the properties must be observable.
/// </summary>
public abstract class ObservablePage : Page, INotifyPropertyChanged, INotifyPropertyChanging
{
    ...
    {
        // CHANGE: Remove configuration check here.
