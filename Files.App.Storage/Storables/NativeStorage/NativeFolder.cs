...
public class NativeFolder(DirectoryInfo directoryInfo, string? name = null) : NativeStorable<DirectoryInfo>(directoryInfo, name), ILocatableFolder, IModifiableFolder, IMutableFolder, IFolderExtended, INestedFolder, IDirectCopy, IDirectMove
{
	...
	/// <inheritdoc/>
	public async virtual IAsyncEnumerable<INestedStorable> GetItemsAsync(StorableKind kind = StorableKind.All, [EnumeratorCancellation] CancellationToken cancellationToken = default)
	{
	...
	/// <inheritdoc/>
	public async virtual Task<INestedStorable> CreateCopyOfAsync(INestedStorable itemToCopy, bool overwrite = default, CancellationToken cancellationToken = default)
	{
	...
	/// <inheritdoc/>
	public async virtual Task<INestedFile> CreateFileAsync(string desiredName, bool overwrite = default, CancellationToken cancellationToken = default)
	{
